    ...
    <div id="payLoadSP" >
    	<div class="row">
			<c:if test="${not empty tipoQueja and (tipoQueja ==1 or tipoQueja==2) }">
					<div  class="caja col-xs-12  col-sm-12 col-sm-offset-0 text-center  well animated bounceInDown" style="border: solid 1vh <c:if test="${tipoQueja == 1 }">#C55</c:if><c:if test="${tipoQueja == 2 }">#5C5</c:if>;padding-top: 0%;min-height: calc(100vh - 115px);    margin-bottom: 4px;">
   						<div class="row">
							 		...
							 		<div class="row">
								 		<div class="col-xs-12 col-sm-6">
								 			<label>Lugar</label>
						                        ...
						                        <div class="input-group">
						                        <label for="imagen"> <span class="btn btn-login btn-block">Select Image</span></label>
    												<input style="visibility: hidden;height: 0px;" id="imagen" class="form-control" type="file" name="imagen">
