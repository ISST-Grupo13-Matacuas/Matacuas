...
<link
	...
	rel="stylesheet">
<link rel="stylesheet"
	href="http://cdn.jsdelivr.net/animatecss/2.1.0/animate.min.css">
<link rel="stylesheet" href="http://openlayers.org/en/v3.2.0/css/ol.css"
	type="text/css">
<link
...
<style>
@import
	url(https://fonts.googleapis.com/css?family=Rubik:400,300,400italic,500italic,500,700,700italic,300italic,900,900italic&subset=latin,latin-ext)
	;

@import
	url(https://fonts.googleapis.com/css?family=Pacifico:400,300,400italic,500italic,500,700,700italic,300italic,900,900italic&subset=latin,latin-ext)
	;
...
<body>
		...
		<div class="col-xs-12 col-sm-3" id="cajaFiltro">
			<div class=" row">
				<div class="col-xs-12 card card-2 text-center">
					...
					<hr>
					<br> <a href="/"><span
						class="glyphicon glyphicon-share-alt glyInv"></span>Volver a la
						app </a> <br> <br>
				</div>
			</div>
		</div>
				...
				<div class="col-xs-12 card card-2" id="cajaInfoPL">
					<div class="row">
						...
						<div class="col-xs-12 text-center">
							...
							<br>
							<p>
								El vehiculo consultado tiene ${numQuejas} queja
								<c:if test="${numQuejas != 1 }">s</c:if>
								y ${numFelicitaciones} felicitacion
								<c:if test="${numFelicitaciones != 1 }">es</c:if>
							</p>
	...
	<div id="foot" class="text-center">Matacuás2016</div>
