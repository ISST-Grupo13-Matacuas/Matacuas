...
public class PruebaBDServlet extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		if (usuarios.size() == 0){
			Usuario usuario1 = daoUser.create("charlygs94@gmail.com", "6784HWT", "gscharly",0,"",false,0,0);
			Usuario moderador = daoUser.create("g.carreto@gmail.com", "8594FBH", "g.carreto",1,"",false,0,0);
